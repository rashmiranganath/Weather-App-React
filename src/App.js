...
// import Reedirect from "./components/weather"
      ...
      <ErrorBoundary>
        <Router>
          <Switch>
            ...
            <Route exact path="/:countryname" component={CountryWeather} />
          </Switch>
        </Router>
      </ErrorBoundary>
    </div>
...
//    const data = await this.props.isLoading ? this.searchValueHandler(countryname) : "";
